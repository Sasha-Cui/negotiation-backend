...
class NegotiationSession:
    ...
    def _generate_plan(self):
        ...
        plan_system = (
            ...
            "- VALUE MAXIMIZATION – Your primary goal is to maximize your own value outcome. Look for trades where you give on lower-value issues to gain on higher-value ones.\n"
            "- COMMUNICATION STRATEGY – When it helps achieve better trades, consider signaling relative priorities (without exact value scoring rules) and structuring proposals that benefit you while addressing their concerns. Be strategic about what you reveal and when.\n"

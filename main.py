...
class NegotiationSession:
    ...
    def _generate_plan(self):
        ...
        plan_system = (
            ...
            "- VALUE MAXIMIZATION – Focus on securing high-value outcomes. When appropriate, consider probing for opponent's priorities and constraints. Consider using opponent's information to look for opportunities to trade lower-value items for ambitiously and credibly larger gains.\n"
